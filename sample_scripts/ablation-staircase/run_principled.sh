...
python watchdog.py --max_retries 120 -- \
    ...
    saving.checkpoint.step_size=6000 \
    'validation=[albedo, roughness, image]' \
    batch_size=128 \
    dataset.n_views=26 \
    learning_rate=0.0005 \
    rendering.spp=16 \
    validation.roughness.step_size=3000 \
    validation.image.step_size=3000 \
    validation.albedo.step_size=3000 \
    n_steps=18000 \
