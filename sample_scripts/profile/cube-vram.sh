...
python watchdog.py --max_retries 1 --timeout 1800 -- \
    --config-name profile_vram \
    out_root=/output/nerad/cube_vram/cube_scene-path_limit_0/albedo_${ALBEDO} \
...
# path-mega always hangs at albedo>=0.7, just ignore it
# for ALBEDO in 0.3 0.5 0.7 0.9 0.95 0.97; do
#     LIMIT=${LIMITS[$ALBEDO]}
#     run \
#         $MITSUBA_BSDF \
